...
func init() {
	flag.StringVar(&stsEndpoint, "sts-ep", "http://127.0.0.1:9000", "STS endpoint")
	flag.StringVar(&minioUsername, "u", "minioadmin", "MinIO Username")
	flag.StringVar(&minioPassword, "p", "minioadmin", "MinIO Password")
	flag.BoolVar(&displayCreds, "d", true, "Only show generated credentials")
	flag.DurationVar(&expiryDuration, "e", 0, "Request a duration of validity for the generated credential")
	flag.StringVar(&bucketToList, "b", "group1", "Bucket to list (defaults to username)")
