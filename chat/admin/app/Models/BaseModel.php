...
{
    const CONN_DEFAULT = '';
    const CONN_CHAT = 'connection_chat';

    protected $conn = self::CONN_CHAT;
     ...
     * @param string $conn
     */
    public static function transaction($conn = self::CONN_CHAT)
    {
     ...
     * @param string $conn
     */
    public static function commit($conn = self::CONN_CHAT)
    {
     ...
     * @param string $conn
     */
    public static function rollBack($conn = self::CONN_CHAT)
    {
        DB::connection(self::connection($conn))->rollBack();
    }

    public static function selectMy($sql, $conn = self::CONN_CHAT)
    {
     ...
     * @param string $conn
     */
    public static function statementMy($sql, $conn = self::CONN_CHAT)
    {
