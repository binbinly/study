...
import (
	...
	"chat/app/chat/handler/http/v1/apply"
	"chat/app/chat/handler/http/v1/chat"
	"chat/app/chat/handler/http/v1/collect"
	"chat/app/chat/handler/http/v1/emoticon"
	"chat/app/chat/handler/http/v1/friend"
	"chat/app/chat/handler/http/v1/group"
	"chat/app/chat/handler/http/v1/moment"
	"chat/app/chat/handler/http/v1/user"
	mw "chat/app/chat/routers/middleware"
	_ "chat/docs"
	"chat/pkg/app"
	"chat/pkg/net/http/middleware"
)
