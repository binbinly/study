...
//FriendInfo 好友详情
func FriendInfo(c *server.Context) (*logic.ReceiveReply, error) {
	return response(service.Svc.FriendInfo(c, c.Req.GetUid(), c.Req.GetId()))
}

//FriendDestroy 好友删除
func FriendDestroy(c *server.Context) (*logic.ReceiveReply, error) {
	return response(nil, service.Svc.FriendDestroy(c, c.Req.GetUid(), c.Req.GetId()))
}

//FriendList 好友列表
func FriendList(c *server.Context) (*logic.ReceiveReply, error) {
	return response(service.Svc.FriendMyAll(c, c.Req.GetUid()))
}

//FriendTagList 标签好友
func FriendTagList(c *server.Context) (*logic.ReceiveReply, error) {
	return response(service.Svc.FriendMyListByTagID(c, c.Req.GetUid(), c.Req.GetId()))
}

//FriendEditBlack 设置黑名单
func FriendEditBlack(c *server.Context) (*logic.ReceiveReply, error) {
...
//FriendEditStar 设置星标
func FriendEditStar(c *server.Context) (*logic.ReceiveReply, error) {
...
func FriendEditAuth(c *server.Context) (*logic.ReceiveReply, error) {
...
func FriendEditRemark(c *server.Context) (*logic.ReceiveReply, error) {
