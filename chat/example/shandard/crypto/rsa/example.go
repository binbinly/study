...
import (
	"chat/example/shandard/crypto/rsa/extra"
	"crypto/rand"
	"crypto/rsa"
	"crypto/x509"
	"encoding/base64"
...
const (
	PublicPemFile       = "example/testdata/rsa_public.pem"
	PublicPKCS1PemFile  = "example/testdata/rsa_public_pkcs1.pem"
	PrivatePemFile      = "example/testdata/rsa_private.pem"
	PrivatePKCS1PemFile = "example/testdata/rsa_private_pkcs1.pem"
)
