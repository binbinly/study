...
// DelCache 删除缓存
func (c *Cache) DelCache(ctx context.Context, id uint32) error {
	return c.Redis.Del(ctx, c.BuildCacheKey([]interface{}{id}))
}

// DelCache2 删除缓存
func (c *Cache) DelCache2(ctx context.Context, a, b uint32) error {
...
func (c *Cache) SetCacheWithNotFound(ctx context.Context, id uint32) error {
	return c.Redis.SetCacheWithNotFound(ctx, c.BuildCacheKey([]interface{}{id}))
}

// SetCacheWithNotFound 设置空
func (c *Cache) SetCacheWithNotFound2(ctx context.Context, a, b uint32) error {
