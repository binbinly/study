...
const (
	...
	periodLuaScript = `local limit = tonumber(ARGV[1])
...
var ErrUnknownCode = errors.New("ratelimit: unknown status code")
...
func (h *PeriodLimit) Take(key string) (int, error) {
	resp, err := h.limitStore.Eval(context.TODO(), periodLuaScript, []string{h.keyPrefix + key}, []string{
