    ...
    if (this.state.zombie !== undefined) {
      ...
      if (this.state.zombie.dna !== undefined) {
        ...
        _className =
          ...
          _shirt;
        _style["color"] = {
          filter: "hue-rotate(" + (dna.substring(6, 9) % 360) + 1 + "deg)",
        };
        _style["skin"] = {
          filter: "hue-rotate(" + (dna.substring(9, 12) % 360) + 1 + "deg)",
        };
        _style["eye_color"] = {
          filter: "hue-rotate(" + (dna.substring(12, 15) % 360) + "deg)",
        };
      }
    }
    return (
      <div className={_className} id="zombie-parts">
        ...
        <img
          alt=""
          src="/left-feet-1@2x.png"
          className="left-feet"
          style={_style["color"]}
        />
        <img
          alt=""
          src="/right-feet-1@2x.png"
          className="right-feet"
          style={_style["color"]}
        />
        <img
          alt=""
          src="/left-leg-1@2x.png"
          className="left-leg"
          style={_style["color"]}
        />
        <img
          alt=""
          src="/right-leg-1@2x.png"
          className="right-leg"
          style={_style["color"]}
        />
        <img
          alt=""
          src="/left-thigh-1@2x.png"
          className="left-thigh"
          style={_style["color"]}
        />
        <img
          alt=""
          src="/right-thigh-1@2x.png"
        ...
        <img
          alt=""
          src="/right-forearm-1@2x.png"
          className="right-forearm"
          style={_style["skin"]}
        />
        <img
          alt=""
          src="/left-upper-arm-1@2x.png"
