...
func TestHttpGet(t *testing.T) {
	...
	resp, err := HttpGet(url, SetHeaderMap(header))
	if err != nil {
		log.Fatal(err)
		t.FailNow()
	}
...
func TestHttpPost(t *testing.T) {
	...
	resp, err := HttpPost(url, SetHeaderMap(header), SetBody(bodyParams))
	if err != nil {
		log.Fatal(err)
		t.FailNow()
	}
...
func TestHttpPut(t *testing.T) {
	...
	resp, err := HttpPut(url, SetHeaderMap(header), SetBody(bodyParams))
	if err != nil {
		log.Fatal(err)
		t.FailNow()
	}
...
func TestHttpPatch(t *testing.T) {
	...
	resp, err := HttpPatch(url, SetHeaderMap(header), SetBody(bodyParams))
	if err != nil {
		log.Fatal(err)
		t.FailNow()
	}
