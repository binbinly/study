...
type OrderService interface {
	...
	/// 订单取消
	OrderCancel(ctx context.Context, in *OrderIDReq, opts ...client.CallOption) (*emptypb.Empty, error)
	/// 订单列表
	OrderList(ctx context.Context, in *ListReq, opts ...client.CallOption) (*ListReply, error)
	/// 订单支付成功回调
	OrderPayNotify(ctx context.Context, in *PayNotifyReq, opts ...client.CallOption) (*emptypb.Empty, error)
	/// 订单退款
	OrderRefund(ctx context.Context, in *RefundReq, opts ...client.CallOption) (*emptypb.Empty, error)
	/// 订单确认收货
	OrderConfirmReceipt(ctx context.Context, in *OrderIDReq, opts ...client.CallOption) (*emptypb.Empty, error)
	/// 订单评价
	OrderComment(ctx context.Context, in *CommentReq, opts ...client.CallOption) (*emptypb.Empty, error)
	/// 内部调用 订单信息
	GetOrderByID(ctx context.Context, in *OrderIDReq, opts ...client.CallOption) (*OrderInfo, error)
}
...
func (c *orderService) OrderCancel(ctx context.Context, in *OrderIDReq, opts ...client.CallOption) (*emptypb.Empty, error) {
...
func (c *orderService) OrderPayNotify(ctx context.Context, in *PayNotifyReq, opts ...client.CallOption) (*emptypb.Empty, error) {
...
func (c *orderService) OrderRefund(ctx context.Context, in *RefundReq, opts ...client.CallOption) (*emptypb.Empty, error) {
...
func (c *orderService) OrderConfirmReceipt(ctx context.Context, in *OrderIDReq, opts ...client.CallOption) (*emptypb.Empty, error) {
...
func (c *orderService) OrderComment(ctx context.Context, in *CommentReq, opts ...client.CallOption) (*emptypb.Empty, error) {
...
func (c *orderService) GetOrderByID(ctx context.Context, in *OrderIDReq, opts ...client.CallOption) (*OrderInfo, error) {
...
type OrderHandler interface {
	...
	/// 内部调用 订单信息
	GetOrderByID(context.Context, *OrderIDReq, *OrderInfo) error
}
...
func RegisterOrderHandler(s server.Server, hdlr OrderHandler, opts ...server.HandlerOption) error {
	type order interface {
		...
		OrderCancel(ctx context.Context, in *OrderIDReq, out *emptypb.Empty) error
		OrderList(ctx context.Context, in *ListReq, out *ListReply) error
		OrderPayNotify(ctx context.Context, in *PayNotifyReq, out *emptypb.Empty) error
		OrderRefund(ctx context.Context, in *RefundReq, out *emptypb.Empty) error
		OrderConfirmReceipt(ctx context.Context, in *OrderIDReq, out *emptypb.Empty) error
		OrderComment(ctx context.Context, in *CommentReq, out *emptypb.Empty) error
		GetOrderByID(ctx context.Context, in *OrderIDReq, out *OrderInfo) error
	}
	type Order struct {
		order
	}
...
func (h *orderHandler) OrderCancel(ctx context.Context, in *OrderIDReq, out *emptypb.Empty) error {
...
func (h *orderHandler) OrderPayNotify(ctx context.Context, in *PayNotifyReq, out *emptypb.Empty) error {
	return h.OrderHandler.OrderPayNotify(ctx, in, out)
}

func (h *orderHandler) OrderRefund(ctx context.Context, in *RefundReq, out *emptypb.Empty) error {
	return h.OrderHandler.OrderRefund(ctx, in, out)
}

func (h *orderHandler) OrderConfirmReceipt(ctx context.Context, in *OrderIDReq, out *emptypb.Empty) error {
	return h.OrderHandler.OrderConfirmReceipt(ctx, in, out)
}

func (h *orderHandler) OrderComment(ctx context.Context, in *CommentReq, out *emptypb.Empty) error {
	return h.OrderHandler.OrderComment(ctx, in, out)
}

func (h *orderHandler) GetOrderByID(ctx context.Context, in *OrderIDReq, out *OrderInfo) error {
