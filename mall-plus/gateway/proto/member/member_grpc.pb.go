...
type MemberClient interface {
	/// 注册
	Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error)
	/// 用户名密码登录
	...
	/// 修改会员信息
	MemberEdit(ctx context.Context, in *MemberEditReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error)
	/// 修改密码
	MemberPwdEdit(ctx context.Context, in *PwdEditReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error)
	/// 获取会员信息
	MemberProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MemberInfoReply, error)
	/// 登出
	Logout(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error)
	/// 添加收货地址
	AddressAdd(ctx context.Context, in *AddressAddReq, opts ...grpc.CallOption) (*AddressIDReply, error)
	/// 修改收货地址
	AddressEdit(ctx context.Context, in *Address, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error)
	/// 收货地址列表
	GetAddressList(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AddressReply, error)
	/// 删除收货地址
	AddressDel(ctx context.Context, in *AddressIDReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error)
	/// 发送短信验证码
...
func (c *memberClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error) {
...
func (c *memberClient) PhoneLogin(ctx context.Context, in *PhoneLoginReq, opts ...grpc.CallOption) (*MemberTokenReply, error) {
	out := new(MemberTokenReply)
	err := c.cc.Invoke(ctx, "/member.Member/PhoneLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) MemberEdit(ctx context.Context, in *MemberEditReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error) {
	out := new(common.SuccessEmptyReply)
	err := c.cc.Invoke(ctx, "/member.Member/MemberEdit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) MemberPwdEdit(ctx context.Context, in *PwdEditReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error) {
	out := new(common.SuccessEmptyReply)
	err := c.cc.Invoke(ctx, "/member.Member/MemberPwdEdit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) MemberProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MemberInfoReply, error) {
	out := new(MemberInfoReply)
	err := c.cc.Invoke(ctx, "/member.Member/MemberProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) Logout(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error) {
	out := new(common.SuccessEmptyReply)
	err := c.cc.Invoke(ctx, "/member.Member/Logout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) AddressAdd(ctx context.Context, in *AddressAddReq, opts ...grpc.CallOption) (*AddressIDReply, error) {
	...
	err := c.cc.Invoke(ctx, "/member.Member/AddressAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) AddressEdit(ctx context.Context, in *Address, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error) {
	out := new(common.SuccessEmptyReply)
	err := c.cc.Invoke(ctx, "/member.Member/AddressEdit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) GetAddressList(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AddressReply, error) {
	...
	err := c.cc.Invoke(ctx, "/member.Member/GetAddressList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) AddressDel(ctx context.Context, in *AddressIDReq, opts ...grpc.CallOption) (*common.SuccessEmptyReply, error) {
	out := new(common.SuccessEmptyReply)
	err := c.cc.Invoke(ctx, "/member.Member/AddressDel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) SendCode(ctx context.Context, in *PhoneReq, opts ...grpc.CallOption) (*CodeReply, error) {
	out := new(CodeReply)
	err := c.cc.Invoke(ctx, "/member.Member/SendCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemberServer interface {
	/// 注册
	Register(context.Context, *RegisterReq) (*common.SuccessEmptyReply, error)
	/// 用户名密码登录
	Login(context.Context, *LoginReq) (*MemberTokenReply, error)
	/// 手机号登录
	PhoneLogin(context.Context, *PhoneLoginReq) (*MemberTokenReply, error)
	/// 修改会员信息
	MemberEdit(context.Context, *MemberEditReq) (*common.SuccessEmptyReply, error)
	/// 修改密码
	MemberPwdEdit(context.Context, *PwdEditReq) (*common.SuccessEmptyReply, error)
	/// 获取会员信息
	MemberProfile(context.Context, *emptypb.Empty) (*MemberInfoReply, error)
	/// 登出
	Logout(context.Context, *emptypb.Empty) (*common.SuccessEmptyReply, error)
	/// 添加收货地址
	AddressAdd(context.Context, *AddressAddReq) (*AddressIDReply, error)
	/// 修改收货地址
	AddressEdit(context.Context, *Address) (*common.SuccessEmptyReply, error)
	/// 收货地址列表
	GetAddressList(context.Context, *emptypb.Empty) (*AddressReply, error)
	/// 删除收货地址
	AddressDel(context.Context, *AddressIDReq) (*common.SuccessEmptyReply, error)
	/// 发送短信验证码
...
func (UnimplementedMemberServer) Register(context.Context, *RegisterReq) (*common.SuccessEmptyReply, error) {
...
func (UnimplementedMemberServer) MemberEdit(context.Context, *MemberEditReq) (*common.SuccessEmptyReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemberEdit not implemented")
}
func (UnimplementedMemberServer) MemberPwdEdit(context.Context, *PwdEditReq) (*common.SuccessEmptyReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemberPwdEdit not implemented")
}
func (UnimplementedMemberServer) MemberProfile(context.Context, *emptypb.Empty) (*MemberInfoReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemberProfile not implemented")
}
func (UnimplementedMemberServer) Logout(context.Context, *emptypb.Empty) (*common.SuccessEmptyReply, error) {
...
func (UnimplementedMemberServer) AddressEdit(context.Context, *Address) (*common.SuccessEmptyReply, error) {
...
func (UnimplementedMemberServer) AddressDel(context.Context, *AddressIDReq) (*common.SuccessEmptyReply, error) {
...
func _Member_PhoneLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/PhoneLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_MemberEdit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/MemberEdit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_MemberPwdEdit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/MemberPwdEdit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_MemberProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/MemberProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/Logout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_AddressAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/AddressAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_AddressEdit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/AddressEdit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).AddressEdit(ctx, req.(*Address))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Member_GetAddressList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/GetAddressList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_AddressDel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/AddressDel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Member_SendCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/member.Member/SendCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
