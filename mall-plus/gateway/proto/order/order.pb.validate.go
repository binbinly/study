...
func (m *OrderInfo) validate(all bool) error {
	...
	// no validation rules for DeliveryCompany

	// no validation rules for DeliveryNo
	...
	// no validation rules for CommentAt
...
// Validate checks the field values on OrderSku with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *OrderSku) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on OrderSku with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in OrderSkuMultiError, or nil
// if none found.
func (m *OrderSku) ValidateAll() error {
	return m.validate(true)
}

func (m *OrderSku) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return OrderSkuMultiError(errors)
	}
	return nil
}

// OrderSkuMultiError is an error wrapping multiple validation errors returned
// by OrderSku.ValidateAll() if the designated constraints aren't met.
type OrderSkuMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OrderSkuMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OrderSkuMultiError) AllErrors() []error { return m }

// OrderSkuValidationError is the validation error returned by
// OrderSku.Validate if the designated constraints aren't met.
type OrderSkuValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OrderSkuValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OrderSkuValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OrderSkuValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OrderSkuValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OrderSkuValidationError) ErrorName() string { return "OrderSkuValidationError" }

// Error satisfies the builtin error interface
func (e OrderSkuValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = OrderSkuValidationError{}
