...
type SeckillClient interface {
	...
	//获取商品秒杀详情
	GetSkuByID(ctx context.Context, in *SkuIdReq, opts ...grpc.CallOption) (*SkuReply, error)
}
...
func (c *seckillClient) Kill(ctx context.Context, in *KillReq, opts ...grpc.CallOption) (*KillReply, error) {
	out := new(KillReply)
	err := c.cc.Invoke(ctx, "/seckill.Seckill/Kill", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seckillClient) GetSessionAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SessionsReply, error) {
	...
	err := c.cc.Invoke(ctx, "/seckill.Seckill/GetSessionAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seckillClient) GetSkusList(ctx context.Context, in *SessionIdReq, opts ...grpc.CallOption) (*SkusReply, error) {
	out := new(SkusReply)
	err := c.cc.Invoke(ctx, "/seckill.Seckill/GetSkusList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seckillClient) GetSkuByID(ctx context.Context, in *SkuIdReq, opts ...grpc.CallOption) (*SkuReply, error) {
	out := new(SkuReply)
	err := c.cc.Invoke(ctx, "/seckill.Seckill/GetSkuByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSeckillServer) GetSkuByID(context.Context, *SkuIdReq) (*SkuReply, error) {
...
func _Seckill_Kill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/seckill.Seckill/Kill",
	}
...
func _Seckill_GetSessionAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/seckill.Seckill/GetSessionAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Seckill_GetSkusList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/seckill.Seckill/GetSkusList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Seckill_GetSkuByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/seckill.Seckill/GetSkuByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeckillServer).GetSkuByID(ctx, req.(*SkuIdReq))
	}
	return interceptor(ctx, in, info, handler)
}
