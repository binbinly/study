import Payment from 'contract/Payment.json'
...
export default {
  ...
  actions: {
    ...
    onNotify({ state }, { address, order_no, trade_no, eth, p_type }) {
      const contract = new state.web3.eth.Contract(Payment.abi, address)
      contract.events
        .Notify(
          {
        ...
        .on('data', function(event) {
          ...
          orderPayNotify({ trans_hash: event.transactionHash, order_no, trade_no, amount: eth * 100, p_type })
        })
